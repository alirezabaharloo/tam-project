...
class ArticleMiddel(models.Model):
    # relational fields
    ip_address = models.ForeignKey(IpAddress, on_delete=models.CASCADE, related_name='article_middle_models')
    article = models.ForeignKey(Article, on_delete=models.CASCADE, related_name='article_middle_models')
    ...
    def __str__(self):
        return f"{self.ip_address} - {self.article}"
