...
@admin.register(ArticleMiddel)
class ArticleMiddelAdmin(admin.ModelAdmin):
    list_display = ('ip_address', 'article', 'created_date')
    search_fields = ('ip_address__address', 'article__title')
    date_hierarchy = 'created_date'
    ordering = ('-created_date',)
